...
$sql_query = "SELECT OPERATOR,trunc(RDATE),SUM(NEW_SUBS) as Total_Sub,SUM(NEW_CHURN) as Total_Churn,SUM(MO) as Mob,SUM(MT) as MsgTermination,SUM(TOTAL_SUBS) as TotalSubs FROM REPORTS_SMS_VASPRO WHERE TO_CHAR(RDATE,'MM-YYYY')='$r_date' GROUP BY OPERATOR,trunc(RDATE) ORDER BY trunc(RDATE)";
//echo '....>'.$sql_query;
...
?>
    <br><br/>
    <?php
    $query2 = "SELECT  trunc(RDATE),SUM(MO) as Mob,SUM(MT) as MsgTermination,SUM(NEW_SUBS) as Total_Sub,SUM(NEW_CHURN) as Total_Churn,SUM(TOTAL_SUBS) as TotalSubs FROM REPORTS_SMS_VASPRO WHERE TO_CHAR(RDATE,'MM-YYYY')='$r_date' GROUP BY trunc(RDATE) ORDER BY trunc(RDATE)";
    ...
    <?php
    $sql_query3 = "SELECT SERVICE_NAME,SUM(NEW_SUBS) as Total_Sub,SUM(NEW_CHURN) as Total_Churn,SUM(MO) as Mob,SUM(MT) as MsgTermination FROM REPORTS_SMS_VASPRO WHERE TO_CHAR(RDATE,'MM-YYYY')='$r_date' GROUP BY SERVICE_NAME ORDER BY SERVICE_NAME";
    ...
    <br><br>
    <?php
    $sql_query = "SELECT OPERATOR,SUM(NEW_SUBS) as Total_Sub,SUM(NEW_CHURN) as Total_Churn,SUM(MO) as Mob,SUM(MT) as MsgTermination FROM REPORTS_SMS_VASPRO WHERE TO_CHAR(RDATE,'MM-YYYY')='$r_date' GROUP BY OPERATOR ORDER BY OPERATOR";
    $res       = helper_exec_select_query($conn, $sql_query);
    /*
      echo '<pre>';
      print_r($res);
