...
include 'db.php';
include 'header.php';
$query_sel = "select * from REPORTS_WAP_VASPRO";
...
<div id="content">
    <table style="width:100%">
        ...
        <tr>
            <td>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;    <input type="radio" name="radAnswer" value="date">Single Date<br>
    ...
    <!-- </form> -->
    <?php
    echo '<iframe name="iframe1" width="900" height="550" src="vaswapdb.php" frameborder="1" scrolling="yes" > </iframe>';
    ?>
</div>
<script type="text/javascript">
    ...
    function view_report()
    {
        ...
        loc = "vaswapdb.php?sdate=" + singledate + "&fdate=" + singledate2 + "&operators=" + operators + "&service_type=" + service_type + "&services=" + services;
