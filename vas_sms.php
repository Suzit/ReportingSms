...
include 'db.php';
include 'header.php';
$query_sel = "select * from REPORTS_SMS_VASPRO";
...
<div id="content">
    ...
    <!-- </form> -->
    <?php
    echo '<iframe name="iframe1" width="900" height="550" src="vas_db.php" frameborder="1" scrolling="yes" > </iframe>';
    ?>
</div>
<script type="text/javascript">
    ...
    function view_report()
    {
        ...
        loc = "vas_db.php?sdate=" + singledate + "&fdate=" + singledate2 + "&operators=" + operators + "&service_type=" + service_type + "&services=" + services;
