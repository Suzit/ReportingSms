...
include 'db.php';
include 'header.php';
$query_sel = "select * from REPORTS_SMS";
...
<div id="content">
    ...
    <!-- </form> -->
    <?php
    echo '<iframe name="iframe1" width="900" height="550" src="databasefile.php" frameborder="1" scrolling="yes" > </iframe>';
    ?>
</div>
<script type="text/javascript">
    ...
    function view_report()
    {
        ...
        loc = "databasefile.php?sdate=" + singledate + "&fdate=" + singledate2 + "&operators=" + operators + "&service_type=" + service_type + "&services=" + services;
